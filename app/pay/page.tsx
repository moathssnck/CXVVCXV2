    ...
    <div className="min-h-screen bg-[#0a0a14] flex flex-col">
      ...
      <header className="py-5 px-5">
        <div className="max-w-md mx-auto flex items-center justify-between">
          <div className="w-11 h-11 rounded-full bg-[#16162a] flex items-center justify-center border border-[#252545]">
      ...
      <main className="flex-1 flex flex-col items-center px-5 pt-10">
        <div className="w-full max-w-sm">
          {/* Phone Icon with Gradient Ring */}
          <div className="flex justify-center mb-10">
            <div className="w-32 h-32 rounded-full bg-gradient-to-br from-[#7c3aed] via-[#a855f7] to-[#c9a962] p-[3px] shadow-xl shadow-purple-900/30">
              <div className="w-full h-full rounded-full bg-[#0a0a14] flex items-center justify-center">
                <svg className="w-16 h-16 text-white/90" fill="none" stroke="currentColor" strokeWidth={1} viewBox="0 0 24 24">
          ...
          <div className="mb-8">
            ...
            <div className="flex gap-3">
              <div className="flex items-center bg-[#16162a] rounded-2xl px-4 py-4 gap-3 border border-[#252545]">
                ...
                />
                <span className="text-white text-[15px] font-medium">+965</span>
              ...
              <input
                ...
                className="flex-1 bg-[#16162a] text-white rounded-2xl px-5 py-4 text-left placeholder:text-gray-600 focus:outline-none focus:ring-2 focus:ring-purple-600/50 border border-[#252545] text-[15px] tracking-widest font-medium"
                dir="ltr"
              />
            </div>
          </div>
